              ...
              onPressed: () async {
                ...
                try {
                  final res = await http.get(
                    ...
                    headers: {
                      'authorization':
                          'Bearer ${await AccountManager.getToken(widget.myUsername)}'
                    },
                  );
                  if (res.statusCode == 200) {
                    final body = jsonDecode(res.body);
                    theirPubB64 = body['pubkey'] as String?;
                  }
                } catch (e) {
                  rootScreenKey.currentState
                ...
                final List<String> sortedNames = [myUsername, otherUsername]
                  ..sort();
                final List<int> myPubBytes = base64Decode(
                    rootScreenKey.currentState!.identityPubKeyBase64!);
